...
(function() {
  ...
  redraw = function() {
    ...
    if (activePerkTreeView) {
      ...
      ctx.fillRect(activePerkTreeView.frame[0] - 1, activePerkTreeView.frame[1] - 1, activePerkTreeView.frame[2] + 500, activePerkTreeView.frame[3] + 2);
  ...
  $(function() {
    ...
    i = 0;
    activePerkTreeView = new PerkTreeView(null, [320, TREE_PADDING, 1523, 787], 3.0);
    for (_i = 0, _len = perkTrees.length; _i < _len; _i++) {
      perkTree = perkTrees[_i];
